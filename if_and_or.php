...
// If $x is greater than 0 && less than 10, echo the result as a sentence "$x is greater than 0 && less than 10".
if($x > 0 && $x < 10) {
	echo "$x is greater than 0 && less than 10\n";
}
// repeat the if statement for $y && $z.
if($y > 0 && $y < 10) {
	echo "$y is greater than 0 && less than 10\n";
}
if($z > 0 && $z < 10) {
	echo "$z is greater than 0 && less than 10\n";
}